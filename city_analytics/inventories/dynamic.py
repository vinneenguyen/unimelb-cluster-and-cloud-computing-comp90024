#!/usr/bin/env python3
# Notice Python 3 is used as interpreter, in stead of Python 2
...
# metadata attribute.
#
# source https://github.com/ansible/ansible/blob/stable-2.9/contrib/inventory/openstack_inventory.py
