...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{city_analytics/City_analytics_report/images/stream.png}
\caption{streaming}
\label{fig:stream}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.7]{city_analytics/City_analytics_report/images/online.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{city_analytics/City_analytics_report/images/deployment.png}
\caption{deploy}
\label{fig:stream}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.7]{city_analytics/City_analytics_report/images/simplifiedtweet.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{city_analytics/City_analytics_report/images/harvester_input.png}
