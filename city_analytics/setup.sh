...
ansible-playbook -i inventories/hosts_auto.ini applications.yaml --skip-tags "remove_directory" # Create couchDB cluster, (CAUTION) comment skip-tags to remove couchDB data on instance
